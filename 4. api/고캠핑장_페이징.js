...
function getList(){
    ...
    .then(data =>{
        ...
        /*// 페이지 블럭 붙이기
        nextPage(document.querySelector('[name=pageNo]').value);
        */
    });
}
...
function nextPage(pageNo){
    ...
    let numOfRows = document.querySelector('[name=numOfRows]').value;
    let totalCnt = document.querySelector('#totalCnt').value;
    let pagesPerBlock = document.querySelector('#pagesPerBlock').value;
    
    console.log(pageNo, numOfRows, totalCnt, pagesPerBlock)
    printPageNave(pageNo,numOfRows,totalCnt,pagesPerBlock);
}